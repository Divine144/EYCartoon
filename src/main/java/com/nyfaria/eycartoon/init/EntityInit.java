...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<BossBabyEntity>> BOSS_BABY = registerEntity("boss_baby", () -> EntityType.Builder.<BossBabyEntity>of(BossBabyEntity::new, MobCategory.MISC).sized(0.5F, 0.5F), BossBabyEntity::createAttributes);
    public static final RegistryObject<EntityType<ElsaEntity>> ELSA_ENTITY = registerEntity("elsa", () -> EntityType.Builder.of(ElsaEntity::new, MobCategory.MISC).sized(0.6F, 1.95F), Mob::createMobAttributes);
